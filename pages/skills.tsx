  ...
  return (
    <div className="pt-[90px] min-h-[100vh]">
      ...
      <div className="flex items-center justify-center flex-col">
        <p className="flex w-full md:px-[50px] lg:px-[400px] pt-[50px] pb-[40px] items-center text-[30px] after:h-[3px] after:grow after:bg-[#686868] after:ml-[30px] before:h-[3px] before:grow before:bg-[#686868] before:mr-[30px]">
          Languages
        </p>
