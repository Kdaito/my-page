  ...
  return (
    <>
      ...
      <div className="w-[100%] md:w-[600px] lg:w-[800px] px-[30px] md:px-0 mx-auto mt-[100px]">
        <h2
          data-aos="fade-up"
          className="w-[100%] lg:w-[70%] text-[20px] lg:text-[32px] font-bold mb-[40px] lg:mb-[50px] flex items-center after:h-[1px] after:grow after:bg-text/[0.3] after:ml-[15px] lg:after:ml-[30px]"
        >
      ...
      <div className="w-[100%] md:w-[600px] lg:w-[800px] px-[30px] md:px-0 mx-auto my-[150px] md:my-[300px]">
        <h2
          data-aos="fade-up"
          className="w-[100%] lg:w-[80%] text-[20px] lg:text-[32px] font-bold mb-[40px] lg:mb-[50px] lg:ml-auto lg:pr-[50px] flex items-center after:h-[1px] after:grow md:after:grow-0 after:bg-text/[0.3] after:ml-[15px] md:after:ml-0 before:h-[1px] md:before:grow before:bg-text/[0.3] md:before:mr-[30px]"
        >
